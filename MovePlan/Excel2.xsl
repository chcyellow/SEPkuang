...
<xsl:template match="/*">
  ...
  <xsl:value-of select="local-name(/*/*)" />
   ...
   x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="14.25">
      <Column ss:Width="61.5" ss:Span="3"/>
      <Column ss:Index="5" ss:Width="129.75"/>
      <Column ss:Width="69.75" ss:Span="1"/>
      <Column ss:Index="8" ss:Width="129.75" ss:Span="1"/>
      <Column ss:Index="10" ss:Width="61.5"/>
		  <Row ss:AutoFitHeight="0" ss:Height="32.25">
			  <Cell ss:MergeAcross="9" ss:StyleID="s28">
				  <Data ss:Type="String">干部走动情况查询报表</Data>
			  </Cell>
		  </Row>
		  <Row>
