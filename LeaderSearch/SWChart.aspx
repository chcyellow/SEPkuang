<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SWChart.aspx.cs" Inherits="LeaderSearch_SWChart" %>
    ...
    <ext:ViewPort ID="ViewPort1" runat="server">
        <Body>
            <ext:BorderLayout ID="BorderLayout1" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ext:ComboBox ID="cbbKind" runat="server" Editable="false" SelectedIndex="0">
                                            <Items>
                                                <ext:ListItem Text="三违级别" Value="0" />
                                                <ext:ListItem Text="三违部门" Value="1" />
                                                <ext:ListItem Text="三违地点" Value="2" />
                                            </Items>
                                        </ext:ComboBox>
                                    </td>
                                    <td>
                ...
                <South>
                    <ext:Panel ID="pnlChart" runat="server" Height="300" Title="三违数据分析" Icon="ChartBar">
                    </ext:Panel>
                </South>
                <Center>
                    <ext:GridPanel 
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
		                    <Columns>
                                <ext:Column Header="三违级别" Width="200" DataIndex="Key" />
                                <ext:Column Header="三违数量" Width="100" DataIndex="Total" />
                                <ext:Column Header="罚款金额" Width="100" DataIndex="Fine" />
		                    </Columns>
                        </ColumnModel>
