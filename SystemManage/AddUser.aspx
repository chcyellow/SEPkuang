<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddUser.aspx.cs" Inherits="SystemManage_AddUser" %>
...
<body>
    ...
    <fieldset id="Fieldset1" class="Fieldsetbox mbox pbox">
        <legend class="fsTitle">初始化用户信息</legend>
        <table width="100%" border="0" cellpadding="0" cellspacing="5">
            <tr>
                ...
                <td>
                    ...
                    <asp:DropDownList ID="ddlUserGroup" runat="server" DataSourceID="odsUserGroup" 
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtPwd" runat="server">123456</asp:TextBox>
                ...
                <td>
                   <asp:DropDownList ID="ddlState" runat="server" Style="width: 160px;">
                            <asp:ListItem Value="1" Selected="True">允许登录</asp:ListItem>
...
<td align="center"><asp:Button ID="btnAddPerson" runat="server" CssClass="btn_2k3" 
        ...
        onclientclick="return confirm(&quot;你确定要添加这些用户吗？&quot;);" /></td>
<td align="center">
