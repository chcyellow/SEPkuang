<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserOptTotal.aspx.cs" Inherits="SystemManage_UserOptTotal" %>
...
<body>
   ...
   <td> 
       <dxe:ASPxComboBox ID="cboMainDept" runat="server" 
   ...
   <td>
    ...
    <div>
        <dxwgv:ASPxGridView ID="gvUserOptTotal" runat="server" Width="100%" 
            ...
            <Columns>
                <dxwgv:GridViewDataTextColumn Caption="部门名称" FieldName="MAINDEPT" 
                    VisibleIndex="0" SortIndex="1" SortOrder="Ascending">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="科区名称" FieldName="DEPTNAME" 
                    VisibleIndex="1">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="点击页面" FieldName="ACTIVEPAGE" 
                    VisibleIndex="2">
                </dxwgv:GridViewDataTextColumn>
                ...
                <dxwgv:GridViewDataTextColumn Caption="姓名" FieldName="NAME" VisibleIndex="4">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="部门编码" FieldName="MAINDEPTID" 
                    VisibleIndex="3" Visible="False">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="科区编码" FieldName="DEPTNUMBER" 
                    VisibleIndex="4" Visible="False">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="点击率" FieldName="PAGECOUNT" 
                    VisibleIndex="5" SortIndex="0" SortOrder="Descending">
                </dxwgv:GridViewDataTextColumn>
            </Columns>
            <StylesEditors>
