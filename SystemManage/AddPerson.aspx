<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPerson.aspx.cs" Inherits="SystemManage_AddPerson" %>
...
<head runat="server">
    ...
    <script type="text/javascript"><!--
        function OnGridSelectionChanged() {
            ...
            xgvPerson.GetSelectedFieldValues('NAME', OnGridSelectionComplete);
        }
