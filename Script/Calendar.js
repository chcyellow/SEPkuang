...
strFrame='<style>';
strFrame+='INPUT.button{BORDER-RIGHT: #c7d4f4 1px solid;BORDER-TOP: #c7d4f4 1px solid;BORDER-LEFT: #c7d4f4 1px solid;';
strFrame+='BORDER-BOTTOM: #c7d4f4 1px solid;BACKGROUND-COLOR: #c7d4f4;font-family:宋体;}';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=160 bordercolor=#c7d4f4 bgcolor=#c7d4f4 >';
...
strFrame+='                <td width=16 align=center bgcolor=#c7d4f4 style="font-size:12px;cursor: hand;color: #ffffff" ';
strFrame+='					   onclick="parent.meizzPrevM()" title="向前翻 1 月" ><b >&lt;</b></td>';
strFrame+='				   <td width=60 align="center" bgcolor="#c7d4f4"  style="font-size:12px;cursor:hand" ';
strFrame+='				       onmouseover="style.backgroundColor=\'#aaccf3\'"';
strFrame+='					   onmouseout="style.backgroundColor=\'#c7d4f4\'" ';
...
strFrame+='					   bgcolor="#c7d4f4" onmouseover="style.backgroundColor=\'#aaccf3\'" ';
strFrame+='					   onmouseout="style.backgroundColor=\'#c7d4f4\'" ';
...
strFrame+='				   <td width=16 bgcolor=#c7d4f4 align=center style="font-size:12px;cursor: hand;color: #ffffff" ';
strFrame+='					   onclick="parent.meizzNextM()" title="向后翻 1 月" ><b >&gt;</b></td>';
strFrame+='			   </tr>';
strFrame+='		   </table></td></tr>';
strFrame+='	   <tr><td width=142 height=18 >';
strFrame+='		   <table border=0 cellspacing=0 cellpadding=2 bgcolor=#c7d4f4 ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
strFrame+='				BORDERCOLORLIGHT=#c7d4f4 BORDERCOLORDARK=#FFFFFF width=140 height=20  style="cursor:' + (bMoveable ? 'move':'default') + '">';
...
strFrame+='    <table border=1 cellspacing=2 cellpadding=2 BORDERCOLORLIGHT=#c7d4f4 BORDERCOLORDARK=#FFFFFF bgcolor=#fff8ec width=140 height=120 >';
...
strFrame+='          <tr bgcolor="#c7d4f4"><td id=bUseTimeLayer width=30  style="cursor:hand" title="点击这里启用/禁用时间"';
strFrame+='				onmouseover="style.backgroundColor=\'#aaccf3\'" align=center onmouseout="style.backgroundColor=\'#c7d4f4\'"';
...
strFrame+=' onmouseover="style.backgroundColor=\'#aaccf3\'" onmouseout="style.backgroundColor=\'#c7d4f4\'"';
...
function meizzSetDay(yy,mm)	//主要的写程序**********
{
	...
	{
		//初始化边框
		da.borderColorLight="#c7d4f4";
		da.borderColorDark="#c7d4f4";
...
* 例如 <input name="time" type="text"   onclick="SetTime(this)"/>
*
************************************/
var str = "";
