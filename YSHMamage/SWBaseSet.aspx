<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SWBaseSet.aspx.cs" Inherits="YSHMamage_SWBaseSet" %>
                ...
                <ext:FormPanel 
                    ...
                    <Body>
                        <ext:FormLayout ID="FormLayout1" runat="server"   LabelAlign="Left" LabelWidth="60">
                            ...
                            <ext:Anchor>
                                <ext:TextArea ID="tfYhcontent" runat="server" FieldLabel="描述" DataIndex="Swcontent" Height="75px" BlankText="描述不能为空" />
                            </ext:Anchor>                        
                      </ext:FormLayout>
                    </Body>
                    <Buttons>
