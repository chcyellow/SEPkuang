<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sw2haz.aspx.cs" Inherits="YSHMamage_Sw2haz" %>
        ...
        <Body>
            ...
            <ext:FormLayout ID="FormLayout2" runat="server" LabelWidth="60">
                ...
                <ext:Anchor Horizontal="95%">
                 ...
                 <ext:Anchor Horizontal="95%">
                    <ext:TextField ID="tf_Yhconcent" runat="server" FieldLabel="三违内容" EmptyText="请输入关键字">
                    </ext:TextField>
                </ext:Anchor>
            </ext:FormLayout>
            </Body>
