<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SWQuote.aspx.cs" Inherits="YSHMamage_SWQuote" %>
                ...
                <Center>
                    <ext:GridPanel 
                            ...
                            <ext:Toolbar ID="Toolbar2" runat="server">
                                <Items>
                                    ...
                                    <ext:Button runat="server" ID="btnquote" Icon="FolderAdd" Text="引用" Disabled="true" >
                                        <Listeners>
                                            <Click Handler="Coolite.AjaxMethods.Swquote();" />
                                        </Listeners>
                                    </ext:Button>
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
	                        <Columns>
	                            <ext:Column Header="编号" Width="100" Sortable="true" DataIndex="Swnumber" />
                                <ext:Column ColumnID="detail" Header="描述" Width="170" Sortable="true" DataIndex="Swcontent">
                                    <Renderer Fn="qtip" />
                                </ext:Column>
                        ...
                        <SelectionModel>
                             <ext:CheckboxSelectionModel ID="RowSelectionModel3" runat="server" SingleSelect="true">
                                ...
                                <Listeners>
                                    <RowSelect Handler="#{FormPanel1}.getForm().loadRecord(record);Coolite.AjaxMethods.detailDet(record.data.Swid);" />
                                </Listeners>
                ...
                <ext:FormPanel 
                    ...
                    <Body>
                        <ext:FormLayout ID="FormLayout1" runat="server"   LabelAlign="Left" LabelWidth="60">
                            ...
                            <ext:Anchor>
                                <ext:TextField ID="TextArea1" runat="server" FieldLabel="编号" DataIndex="Swnumber" BlankText="编号不能为空" Disabled="true" />
                            </ext:Anchor>
                            <ext:Anchor>
                               <ext:ComboBox 
                                    ID="cbbLevelid" 
                            ...
                            <ext:Anchor>
                                <ext:TextArea ID="tfSwcontent" runat="server" FieldLabel="描述" DataIndex="Swcontent" Height="75px" BlankText="描述不能为空" Disabled="true" />
                            </ext:Anchor>                        
                      </ext:FormLayout>
                    </Body>
                    <Buttons>
                        <ext:Button ID="btnUpdate" runat="server" Icon="Add" Text="更新">
                            <Listeners>
                                <Click Handler="if(!#{tfSwcontent}.validate()){Ext.Msg.alert('提示','描述不能为空！'); return false;}" />
                            </Listeners>
                            <AjaxEvents>
                                <Click  OnEvent="btnUpdateClick">
                                    <EventMask CustomTarget="={#{tfSwcontent}.body}"  Target="CustomTarget" ShowMask="true" MinDelay="20" />
                                </Click>
                            </AjaxEvents>
                        </ext:Button>
