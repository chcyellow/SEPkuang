<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PersonManage.aspx.cs" Inherits="BaseManage_PersonManage" %>
...
<body>
    ...
    <table borderColor="#fffbec" cellSpacing="0" cellPadding="0" width="100%" align="center" bgColor="#fffbec" border="1" frame="void">
        <tbody>
        <tr align="left">
        <td height="20">你现在的位置是：基础信息->人员管理</td></tr>
        </tbody>
    </table>
    ...
    <dxwgv:aspxgridview id="xgvPerson" runat="server" autogeneratecolumns="False" clientinstancename="xgvPerson"
               ...
               onhtmlrowprepared="xgvPerson_HtmlRowPrepared" 
            onrowupdating="xgvPerson_RowUpdating" 
            onbeforecolumnsortinggrouping="xgvPerson_BeforeColumnSortingGrouping"><Columns>
<dxwgv:GridViewDataTextColumn Caption="人员ID" FieldName="PERSONID" Visible="False"
            ...
            <dxwgv:GridViewDataTextColumn FieldName="PERSONNUMBER" Caption="工号" 
             ...
             <dxwgv:GridViewDataComboBoxColumn Caption="性别" FieldName="SEX" 
             ...
             <dxwgv:GridViewDataComboBoxColumn Caption="职务" FieldName="POSID" 
                VisibleIndex="4" Width="150px">
                 <PropertiesComboBox DataSourceID="adsPos" TextField="Posname" 
                     ValueField="Posid" ValueType="System.String">
                 </PropertiesComboBox>
            </dxwgv:GridViewDataComboBoxColumn>
             <dxwgv:GridViewDataTextColumn Caption="电话" FieldName="TEL" VisibleIndex="7" 
                Width="200px">
             ...
             <dxwgv:GridViewDataTextColumn Caption="科区" FieldName="DEPTID" VisibleIndex="5" 
                ReadOnly="True">
            </dxwgv:GridViewDataTextColumn>
           <dxwgv:GridViewDataTextColumn Caption="单位" FieldName="MAINDEPTID" 
               VisibleIndex="6" ReadOnly="True">
           </dxwgv:GridViewDataTextColumn>
           <dxwgv:GridViewDataComboBoxColumn Caption="启用/禁用" FieldName="PERSONSTATUS" 
                    VisibleIndex="7">
                    <PropertiesComboBox ValueType="System.String">
                        <Items>
            ...
            <dxwgv:GridViewCommandColumn Caption="编辑" VisibleIndex="8">
...
<FilterRowButton Height="13px" Width="13px"></FilterRowButton>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
     ...
     <cc1:ALinqDataSource ID="adsPos" runat="server" 
        ContextTypeName="GhtnTech.SEP.DAL.DBSCMDataContext" TableName="Position" 
            Where="Maindeptid == @Maindeptid">
         <WhereParameters>
             <asp:ControlParameter ControlID="ddlDept" Name="Maindeptid" 
