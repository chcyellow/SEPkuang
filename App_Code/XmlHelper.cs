...
public class XmlHelper
{
    ...
    public static void WriteXml<T>(Page page, string xmlPath, List<T> lst)
    {
        TextWriter writer = new StreamWriter(page.Server.MapPath("~/") + xmlPath + "/" + "person.xml");
        XmlSerializer serializer = new XmlSerializer(typeof(List<T>));
        serializer.Serialize(writer, lst);
        writer.Close();
    }
    public static  List<string> ReadXml(Page page, string xmlPath,string fileName)
    {
        XmlReader reader = new XmlTextReader(page.Server.MapPath("~/") + xmlPath + "/" + fileName);
