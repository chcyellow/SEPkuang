<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DanweiPoint.aspx.cs" Inherits="kaohe_DanweiPoint" %>
     ...
     <h1></h1>
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" 
           ...
           Width="600px" 
            ...
            <dxwgv:GridViewDataTextColumn Caption="A级" FieldName="A级" VisibleIndex="3" Width="80px"> 
            <HeaderStyle HorizontalAlign="Center" /> 
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="B级" FieldName="B级" VisibleIndex="4" Width="80px">  
            <HeaderStyle HorizontalAlign="Center" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="C级" FieldName="C级" VisibleIndex="5" Width="80px">  
            <HeaderStyle HorizontalAlign="Center" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="D级" FieldName="D级" VisibleIndex="6" Width="80px">  
            <HeaderStyle HorizontalAlign="Center" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="总数" FieldName="隐患总数" VisibleIndex="7" Width="80px">  
            <HeaderStyle HorizontalAlign="Center" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="隐患积分" Caption="隐患积分" VisibleIndex="34" 
                    UnboundType="Integer" SortIndex="0" SortOrder="Descending" >
                 <Settings AllowSort="True" />
                 <HeaderStyle HorizontalAlign="Center" />
                 <FooterCellStyle ForeColor="Brown" />          
             </dxwgv:GridViewDataTextColumn>
             <dxwgv:GridViewDataTextColumn FieldName="处罚总数" Caption="处罚总数" VisibleIndex="34" 
                    UnboundType="Integer" SortIndex="0" SortOrder="Descending" >
                 <Settings AllowSort="True" />
                 <HeaderStyle HorizontalAlign="Center" />
                 <FooterCellStyle ForeColor="Brown" />          
