<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PersonSWPoint2.aspx.cs" Inherits="kaohe_PersonSWPoint2" %>
...
<body>
   ...
   <td>
    ...
    <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" 
        ...
        <SettingsEditing EditFormColumnCount="2" Mode="PopupEditForm" PopupEditFormWidth="450px" />
        <Settings ShowTitlePanel="true" />
        <SettingsText Title="个人三违积分" />
        <Columns>
<dxwgv:GridViewDataTextColumn FieldName="PERSONNUMBER" Caption="人员编号" VisibleIndex="0" 
                Visible="False">
</dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="姓名" FieldName="PERSONNAME" VisibleIndex="0"  Width="15%">
            <HeaderStyle HorizontalAlign="Center" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="特别严重" FieldName="特别严重" VisibleIndex="1"  >
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="严重" FieldName="严重" VisibleIndex="2"  >
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="一般" FieldName="一般" VisibleIndex="3"  >
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="轻微" FieldName="轻微" VisibleIndex="4"  >
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="不规范行为" FieldName="不规范行为" VisibleIndex="5"  >
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="三违总数" FieldName="三违总数" VisibleIndex="6"  
                SortIndex="0" SortOrder="Descending">
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="总积分" FieldName="TOTAL" 
                VisibleIndex="7"  SortIndex="1" SortOrder="Descending">
            </dxwgv:GridViewDataTextColumn>
        </Columns>
        <StylesEditors>
