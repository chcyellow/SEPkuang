<%@ Page Language="C#" AutoEventWireup="true" CodeFile="danweiSWPoints.aspx.cs" Inherits="kaohe_danweiSWPoints" %>
...
<body>
   ...
   <td>
    ...
    <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" 
        ...
        <SettingsText Title="单位三违积分" />
        <Columns>
            <dxwgv:GridViewDataTextColumn Caption="三违单位" FieldName="DEPTNAME" VisibleIndex="0" Width="100px">
            <HeaderStyle HorizontalAlign="Center" />
            </dxwgv:GridViewDataTextColumn>
             <dxwgv:GridViewDataTextColumn Caption="严重" FieldName="严重" VisibleIndex="1"  Width="100px">
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="一般" FieldName="一般" VisibleIndex="2"  Width="100px">
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="轻微" FieldName="轻微" VisibleIndex="3"  Width="100px">
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="总数" FieldName="三违总数" VisibleIndex="4"  Width="100px">
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="积分" FieldName="三违积分" VisibleIndex="5"  Width="100px">
            </dxwgv:GridViewDataTextColumn>
        </Columns>
        <StylesEditors>
