...
public partial class kaohe_PersonSWFine2 : BasePage
{
    ...
    private void Bind(string deptnm,string psn)
    {
        ...
        DataSet ds = GetKaoHeInfo.GetPersonSWFine(deteedit.Date, ASPxDateEdit1.Date, deptnm,psn);
    ...
    protected void ASPxGridView1_CustomUnboundColumnData(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewColumnDataEventArgs e)
    {
        ...
        {
            decimal price1 = (decimal)e.GetListSourceFieldValue("KC");
            decimal price2 = (decimal)e.GetListSourceFieldValue("ZC");
