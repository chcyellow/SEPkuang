...
public partial class kaohe_DeptYHPoint2 : BasePage
{
    ...
    {
        DataSet ds = GetKaoHeInfo.GetDeptYHPoint(deteedit.Date, ASPxDateEdit1.Date, deptnm,kequ);
    ...
    {
        if (e.Column.FieldName == "总积分")
        {
            decimal price1 = (decimal)e.GetListSourceFieldValue("矿查总积分");
            decimal price2 = (decimal)e.GetListSourceFieldValue("自查总积分");
