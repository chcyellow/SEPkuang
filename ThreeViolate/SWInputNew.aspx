<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SWInputNew.aspx.cs" Inherits="ThreeViolate_SWInputNew" %>
                                    ...
                                    <ext:Anchor Horizontal="92%">
                                        ...
                                        <ext:Anchor Horizontal="92%">
                                           ...
                                           <ext:Anchor Horizontal="92%">
                                            ...
                                            ListWidth="600"
                                            FieldLabel="三违描述<font color='red'>*</font>"
                        ...
                        <ext:Panel ID="Panel2" runat="server" Border="false">
                            ...
                            <Body>
                                <ext:FormLayout ID="FormLayout2" runat="server" LabelAlign="Left" LabelWidth="70">
                                    ...
                                    <ext:Anchor Horizontal="92%">
                                        <ext:TextArea ID="TextArea1" runat="server" FieldLabel="备注" AllowBlank="true">
                                        </ext:TextArea>
                                    </ext:Anchor>
                                </ext:FormLayout>
                            </Body>
