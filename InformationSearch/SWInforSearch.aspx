<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SWInforSearch.aspx.cs" Inherits="InformationSearch_SWInforSearch" %>
         ...
         <ext:Window 
            ...
            <Body>
                <ext:FormLayout ID="FormLayout2" runat="server" LabelWidth="60">
                    ...
                    <ext:Anchor Horizontal="95%">
                        <ext:MultiField ID="MultiField1" runat="server" FieldLabel="人员信息">
                            <Fields>
                                <ext:ComboBox 
                                    ID="cbbSWPerson"
                                    runat="server"    
                                    ...
                                    HideTrigger="true" Note="三违人员" Width="100"  
                                    > 
                                    <Listeners>
                                ...
                                <ext:ComboBox 
                                    ...
                                    DisplayField="Name" 
                                    ValueField="Personnumber"
                                    HideTrigger="true" Note="排查人员"  Width="100" 
                                    > 
                                    <Listeners>
                                        <Render Fn="function(f) {
                                                    f.el.on('keyup', function(e) {
