<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YHInput.aspx.cs" Inherits="YSNewProcess_YHInput" %>
...
<body>
    ...
    <ext:ScriptManager ID="ScriptManager1" runat="server" Locale="zh-CN" CleanResourceUrl="false" />
        ...
        <ext:Store ID="YHputinStore" runat="server"  OnRefreshData="YHputinStore_RefershData" AutoLoad="true">
        <Proxy>
                <ext:DataSourceProxy>
                </ext:DataSourceProxy>
         </Proxy>
    ...
    <ext:ViewPort ID="ViewPort1" runat="server">
        <Body>
                            ...
                            <Body>
                                <ext:FormLayout ID="FormLayout1" runat="server" LabelAlign="Left" LabelWidth="70" >
                                    <ext:Anchor Horizontal="92%">
                                        <ext:DateField ID="dfPCtime" FieldLabel="排查时间" runat="server" Vtype="daterange" Disabled="true">
                                        </ext:DateField>
                                    </ext:Anchor>
                                    <ext:Anchor Horizontal="92%">
                                        <ext:ComboBox 
                                       ...
                                       <ext:Anchor Horizontal="92%">
                                        ...
                                        <ext:ComboBox 
                                            ...
                                            ForceSelection="true" HideTrigger="true"
                                            FieldLabel="隐患内容<font color='red'>*</font>"
                                ...
                                <ext:FormLayout ID="FormLayout2" runat="server" LabelAlign="Left" LabelWidth="70">
                                    ...
                                    <ext:Anchor Horizontal="92%">
                                        <ext:ComboBox 
                                            ...
                                            FieldLabel="发生班次<font color='red'>*</font>">
                                            <Items>
                                    ...
                                    <ext:Anchor Horizontal="92%">
                                        <ext:TextArea ID="TextArea1" runat="server" FieldLabel="备注" Height="40">
                                        </ext:TextArea>
                                    </ext:Anchor>
                                    <ext:Anchor Horizontal="92%">
                                        <ext:ComboBox 
            ...
            <Buttons>
                ...
                <ext:Button ID="Button2" runat="server" Text="当前地点隐患复查" Icon="ZoomIn" >
                    <AjaxEvents>
            ...
            <ColumnModel ID="ColumnModel1" runat="server" >
                <Columns>
                    <ext:Column Header="编号" DataIndex="YHPutinID" Width="50" >
                    </ext:Column>
                    <ext:Column  Header="部门" Sortable="true" Width="80"
                        DataIndex="DeptName" >
                    </ext:Column>
                    <ext:Column ColumnID="yhcontent" Header="隐患内容" DataIndex="YHContent">
                        <Renderer Fn="qtip" />
                    </ext:Column>
                    <ext:Column Header="备注" DataIndex="Remarks" Width="100">
                        <Renderer Fn="qtip" />
                    </ext:Column>
                    <ext:Column Header="排查人" DataIndex="Name" Width="80">
                        <Renderer Fn="qtip" />
                    </ext:Column>
                    <ext:Column Header="地点" Sortable="true"  DataIndex="PlaceName" Width="100">
                    </ext:Column>
                    ...
                    <ext:Column Header="录入时间" Width="70" Sortable="true" DataIndex="INTime" >
                        <Renderer Fn="Ext.util.Format.dateRenderer('Y-m-d H:i:s')" />
                    </ext:Column>
                    <ext:Column  Header="状态" Sortable="true" Align="Center" Width="60"
                        DataIndex="Status" >
                        <Renderer Fn="change" />
                    </ext:Column>
                </Columns>
            ...
            <BottomBar>
                <ext:PagingToolBar ID="pagecut" runat="server" PageSize="10" StoreID="YHputinStore" />
            </BottomBar>
            <SelectionModel>
                            ...
                            <Body>
                                ...
                                <ColumnModel ID="ColumnModel3" runat="server">
		                            <Columns>
                                        ...
                                        <ext:Column Header="内容" Width="100" Sortable="true" DataIndex="YHContent" >
                                            <Renderer Fn="qtip" />
                                        </ext:Column>
                                        <ext:Column Header="备注" Width="100" Sortable="true" DataIndex="Remarks" >
                                            <Renderer Fn="qtip" />
                                        </ext:Column>
                                        <ext:Column Header="部门" Width="60" Sortable="true" DataIndex="DeptName" >
                                        </ext:Column>
                                        <ext:Column Header="地点" Width="70" Sortable="true" DataIndex="PlaceName" >
                                        </ext:Column>
                                        <ext:Column Header="排查人" Width="60" Sortable="true" DataIndex="Name" >
                                        </ext:Column>
                                        <ext:Column Header="排查时间" Width="65" Sortable="true" DataIndex="PCTime" >
                                        <Renderer Fn="Ext.util.Format.dateRenderer('Y-m-d')" /></ext:Column>
                                        <ext:Column Header="类型" Width="45" Sortable="true" DataIndex="YHType" >
                                        </ext:Column>
                                        <ext:Column Header="级别" Width="45" Sortable="true" DataIndex="YHLevel" >
                                        </ext:Column>
		                            </Columns>
                                </ColumnModel>
                                <LoadMask ShowMask="true" />
    ...
    <ext:Window ID="Window2"  runat="server" 
        ...
        <Listeners>
            <BeforeShow Handler="refreshTree(#{tpPerson});" />
        </Listeners>
    </ext:Window>
