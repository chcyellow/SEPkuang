<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SWProcess.aspx.cs" Inherits="YSNewProcess_SWProcess" %>
        ...
        <ext:ViewPort ID="ViewPort1" runat="server">
            ...
            <ColumnModel ID="ColumnModel1" runat="server">
		        <Columns>
                    ...
                    <ext:Column Header="报送时间" Width="70" Sortable="true" DataIndex="Intime" >
                        <Renderer Fn="Ext.util.Format.dateRenderer('Y-m-d')" />
                    </ext:Column>
                    ...
                    <ext:Column Header="检查方式" Width="75" Sortable="true" DataIndex="Jctype">
                        ...
                        <Body>
                            <table style="width:100%;">
                                ...
                                <tr>
                                    ...
                                    <td style="width:80%;">
                                        <ext:TextField ID="lbl_Fine" runat="server" Cls="x-textfeild-style" Disabled="true" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:20%;">
                                        <span class="x-label-text">是否进三违学习班:</span>
                                    </td>
                                    <td style="width:80%;">
                                        <ext:RadioGroup ID="RadioGroup3" runat="server" FieldLabel="是否进班" Width="100px">
                                            <Items>
                                                <ext:Radio runat="server" ID="Radio5" Checked="True" BoxLabel="是" AutoWidth="true" Width="20px">
                                                </ext:Radio>
                                                <ext:Radio runat="server" ID="Radio6" BoxLabel="否" AutoWidth="true" Width="20px">
                                                </ext:Radio>
                                            </Items>
                                        </ext:RadioGroup>
                                    </td>
