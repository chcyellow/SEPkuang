<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YHProcess.aspx.cs" Inherits="YSNewProcess_YHProcess" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var changenum = function(value) {
            ...
            return String.format(template, color, vak);
        }

        var changejc = function(value) {
            var color; var vak
            if (value == 1) {
                color = 'green';
                vak = '自查';
...
<body>
        ...
        <Reader>
            <ext:JsonReader ReaderID="Yhputinid">
                <Fields>
                    ...
                    <ext:RecordField Name="Fcpersonname" />
                    ...
                    <ext:RecordField Name="Jctype" />
                    <ext:RecordField Name="Isfine" />
    ...
    <ext:Store ID="zrbdStore" runat="server">
        <Reader>
            <ext:JsonReader ReaderID="Deptnumber">
                <Fields>
                    <ext:RecordField Name="Deptnumber"/>
    ...
    <%--数据列表--%>
        ...
        <ColumnModel ID="ColumnModel1" runat="server">
		    <Columns>
                <ext:Column Header="隐患编号" Width="60" DataIndex="Yhputinid" />
                <ext:Column Header="隐患部门" Width="70" DataIndex="Deptname" />
                <ext:Column Header="隐患地点" Width="100" DataIndex="Placename" />
                <ext:Column Header="班次" Width="40" DataIndex="Banci" />
                <ext:Column ColumnID="NIid" Header="隐患内容" Width="120" Sortable="false" DataIndex="HBm">
                    <Renderer Fn="qtip" />
                </ext:Column>
                <ext:Column Header="备注" Width="100" DataIndex="Remarks">
                    <Renderer Fn="qtip" />
                </ext:Column>
                <ext:Column Header="排查人员" Width="45" DataIndex="Personname">
                    <Renderer Fn="qtip" />
                </ext:Column>
                <ext:Column Header="复查人员" Width="45" DataIndex="Fcpersonname">
                </ext:Column>
                <ext:Column Header="排查时间" Width="75" Sortable="true" DataIndex="Pctime" >
                    <Renderer Fn="Ext.util.Format.dateRenderer('Y-m-d')" />
                </ext:Column>
                <ext:Column Header="级别" Width="35" Sortable="true" DataIndex="Levelname" >
                <Renderer Fn="changeColor" />
                </ext:Column>
                 
                <ext:Column Header="隐患类型" Width="60" Sortable="true" DataIndex="Zyname" />
                <ext:Column Header="备注" Width="100" Sortable="true" DataIndex="Remarks" Hidden="true" />
                <ext:Column Header="处罚" Width="35" Sortable="true" DataIndex="Isfine">
                    <Renderer Fn="changenum" />
                </ext:Column>
                <ext:Column Header="检查方式" Width="60" Sortable="true" DataIndex="Jctype">
                    <Renderer Fn="changejc" />
                </ext:Column>
        ...
        <TopBar>
            <ext:Toolbar runat="server" ID="tb1">
                <Items>
                    ...
                    <ext:Button runat="server" ID="btnBulkClose" Icon="FolderTable" Text="批量闭合隐患">
                        <Listeners>
                            <Click Handler="Coolite.AjaxMethods.YHycfkLoad2();#{Window7}.show();" />
                        </Listeners>
                    </ext:Button>
                    ...
                    <ext:Button runat="server" ID="btnFineSet" Icon="FolderTable" Text="填报处罚信息">
                        <Listeners>
                            <Click Handler="Coolite.AjaxMethods.SelectPerson();" />
                        </Listeners>
                    </ext:Button>
                    <ext:ToolbarFill />
                ...
                <ext:TabPanel 
                    ...
                    <Tabs>
                        <ext:Tab ID="Tab1" runat="server" Title="隐患发布">
                                ...
                                <table style="width:570px;">
                                    ...
                                    <tr>
                                        <td style="width:50%;">
                                            <table width="100%">
                                                <tr>
                                                    <td style="width:50%;"> 
                                                        <span class="x-label-text">责任科区:</span>
                                                        <ext:ComboBox 
                                                            ID="fb_zrdw" 
                                                            runat="server"
                                                            ...
                                                            >
                                                            <Listeners>
                                                                <Select Handler="Coolite.AjaxMethods.zrbdLoad();" />
                                                            </Listeners>
                                                        </ext:ComboBox>
                                                    </td>
                                                    <td style="width:50%;">
                                                        <span class="x-label-text">责任班队:</span>
                                                        <ext:ComboBox 
                                                            ID="cbb_zrbd" 
                                                            runat="server"
                                                            StoreID="zrbdStore" DisplayField="Deptname" ValueField="Deptnumber"
                                                            Width="120px" 
                                                            >
                                                            <Listeners>
					                                    ...
					                                    <tpl for=".">
						                                    <tpl if="[xindex] == 1">
							                                    <table class="cbStates-list">
								                                    <tr>
									                                    <th style="font-weight: bold">工号</th>
									                                    <th style="font-weight: bold">姓名</th>
								                                    </tr>
						                                    </tpl>
						                                    <tr class="list-item">
							                                    <td width="100px">{Personnumber}</td>
                                   ...
                                   <%-- <tr>
                                         <td style="width:50%;" colspan="2">
                                            <span class="x-label-text">罚款人员:</span>
                                             <ext:MultiField ID="fb_mffk" runat="server" Width="520px">
                                                <Fields />
                                             </ext:MultiField>
                            ...
                            <Buttons>
                                <%--<ext:Button ID="btnSelectPerson" runat="server" Text="罚款人员选择">
                                    <Listeners>
                                        <Click Handler="Coolite.AjaxMethods.SelectPerson();" />
                                    </Listeners>
                                </ext:Button>--%>
                                <ext:Button ID="btn_fb" runat="server" Text="发 布">
                                    <AjaxEvents>
                                        <Click OnEvent="YHpublish" Method="POST">
    ...
    <ext:Window 
        ...
        <Body>
            <ext:FormLayout ID="FormLayout10" runat="server" LabelWidth="60">
                <ext:Anchor Horizontal="95%">
                    <ext:ComboBox ID="zgfk_zgqk" runat="server" FieldLabel="整改情况" Editable="false">
                        <Items>
        ...
        <Buttons>
            <%--<ext:Button ID="Button7" runat="server" Text="罚款人员选择">
                <Listeners>
                    <Click Handler="Coolite.AjaxMethods.SelectPerson();" />
                </Listeners>
            </ext:Button>--%>
    ...
    <ext:Window 
        ...
        <Body>
            <ext:FormLayout ID="FormLayout3" runat="server" LabelWidth="60">
                ...
                <ext:Anchor Horizontal="95%">
                    <ext:ComboBox ID="fcfk_fcqk" runat="server" FieldLabel="复查情况" Editable="false">
                        <Items>
    ...
    <ext:Window 
        ...
        <Body>
            <ext:FormLayout ID="FormLayout5" runat="server" LabelWidth="60">
                <ext:Anchor Horizontal="95%">
                    <ext:TextField ID="TextField2" runat="server" FieldLabel="隐患编号" Disabled="true">
                    </ext:TextField>
                </ext:Anchor>
                <ext:Anchor Horizontal="95%">
                    <ext:ComboBox 
        ...
        <Buttons>
            <ext:Button ID="Button7" runat="server" Text="提 交">
                <Listeners>
                    <Click Handler="Coolite.AjaxMethods.YHycfk2();" />
                </Listeners>
            </ext:Button>
        </Buttons>
    </ext:Window>
            ...
            <ext:Panel ID="Panel2" runat="server" Width="400">
                <Body>
                    <table style="width:385px;">
                        ...
                        <tr>
                             <td colspan="2">
                                <span class="x-label-text">批示/备注:</span>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <span class="x-label-text"> </span>
                                <ext:Checkbox ID="Checkbox1" runat="server" BoxLabel="确认罚款" Width="300px" Checked="true" >
                                    <%--<Listeners>
                ...
                <Buttons>
                    <ext:Button ID="Button6" runat="server" Text="发 布">
                        <Listeners>
                            <Click Handler="Coolite.AjaxMethods.yqYHpublishSure();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
            </ext:Panel>
